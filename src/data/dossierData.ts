import { EbitdaData, RevenueSeason, RoomAsset, SwotCategory, RiskFactor, DataRoomDoc } from '../types';
...
export const EBITDA_HISTORY: EbitdaData[] = [
  {
    year: '2023',
    ebitda: 39222,
    revenue: 94100,
...
export const REVENUE_SEASONS: RevenueSeason[] = [
  {
...
export const RISK_RETURN_BENCHMARKS = [
