...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="bg-white text-slate-900 border-b border-slate-200">
      ...
      <nav className="bg-[#0C2340] text-white flex flex-wrap items-center justify-between px-6 lg:px-12 py-3 text-xs uppercase tracking-wider font-bold">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-12 lg:py-16 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch">
        
        {/* Left Column: Title & Description */}
        <div className="lg:col-span-8 flex flex-col justify-between space-y-8 border-b lg:border-b-0 lg:border-r border-slate-200 pb-8 lg:pb-0 lg:pr-12">
          <div>
            ...
            <h1 className="text-4xl sm:text-6xl font-black leading-[1.1] tracking-tight text-[#0C2340]">
              Besmart <br />
          ...
          <div className="flex flex-wrap items-center gap-3 pt-4">
            <button
              ...
              className="flex items-center gap-2 bg-[#0C2340] hover:bg-[#061528] text-white font-bold py-3.5 px-7 rounded-xl text-xs uppercase tracking-wider transition-all cursor-pointer shadow-lg shadow-[#0C2340]/20"
            >
        ...
        <div className="lg:col-span-4 bg-[#0C2340] text-white rounded-3xl border border-slate-800 flex flex-col justify-between overflow-hidden shadow-xl">
          ...
          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
            ...
            <div className="absolute bottom-3 left-6 right-6 flex items-center justify-between">
              <div>
                <span className="text-[10px] font-extrabold uppercase tracking-widest text-[#00A8B5] px-2.5 py-0.5 bg-[#0C2340]/90 rounded border border-[#00A8B5]/30">
                  Fotografia Real
                </span>
                <p className="text-xs font-bold text-white mt-1">Fachada Besmart Residence</p>
              </div>
              <span className="text-[10px] font-bold text-slate-300 bg-slate-900/80 px-2 py-0.5 rounded">
                Centro Histórico
              </span>
            </div>
          </div>
